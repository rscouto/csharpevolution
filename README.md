...
* **Sintaxe Básica 01:** [Namespaces](https://docs.microsoft.com/pt-br/dotnet/csharp/programming-guide/namespaces/), **Classes**, **Structs**, **Principais Tipos Primitivos**, **Principais Tipos de Referência**, **Tipo de Acessibilidade(Classes e métodos)**.
